            ...
            <div class="card-body">
                <form action="{{ route('tickets.update', $ticket->id) }}" method="POST">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    <option value="success"   {{ old('status', $ticket->status) == 'success' ? 'selected' : '' }}>Success</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="type_carrier" id="type_carrier" class="form-control"
                                    value="{{ old('type_carrier', $ticket->type_carrier ?? '') }}" readonly>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="plate_number" id="plate_number" class="form-control"
                                    value="{{ old('plate_number', $ticket->plate_number ?? '') }}" readonly>
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <a href="{{ route('tickets.index') }}" class="btn btn-outline-secondary">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
